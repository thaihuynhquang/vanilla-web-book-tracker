...
const LAB_CONTENT_EN: Record<string, { title: string; goal: string; requirements: string[]; acceptanceCriteria: string[] }> = {
  "lab-ch-1": {
...
const QUIT_CRITERIA_EN: Record<string, { stopSignal: string; exitCriteria: string }> = {
  "ch-1": {
